    ...
    <div className="p-8">
      ...
      <div className="bg-mainPurple rounded-md p-8 items-center flex">
        ...
        <div className="flex space-x-4 ml-auto">
          <button className="button hover:bg-opacity-90 bg-lightBlue">
            Invest and Earn
          </button>
          <button className="button hover:bg-opacity-90 bg-green-500">
            Deposit
          </button>
          <button className="button hover:bg-opacity-90 bg-red-500">
            Withdraw
          </button>
        </div>
      </div>
      ...
      <div className="p-8 rounded-lg bg-mainPurple">
        ...
        <div className="grid grid-cols-3 my-3 hover:bg-deepPurple p-2 rounded-md transition-all duration-200 ease-in-out">
          <p className="text-white uppercase opacity-80 text-center">$500</p>
          <p className="uppercase opacity-80 text-center text-deposit-500 text-green-500">
            Deposit
          </p>
          <p className="uppercase opacity-80 text-center text-green-500">
            Successful
          </p>
        </div>
        <div className="grid grid-cols-3 my-3 hover:bg-deepPurple p-2 rounded-md transition-all duration-200 ease-in-out">
          <p className="text-white uppercase opacity-80 text-center">$150</p>
          <p className="uppercase opacity-80 text-center text-deposit-500 text-red-500">
            Withdrawal
          </p>
          <p className="uppercase opacity-80 text-center text-green-500">
            Successful
